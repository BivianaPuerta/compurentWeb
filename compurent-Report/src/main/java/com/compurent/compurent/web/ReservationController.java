...
import com.compurent.compurent.model.report.CountStatus;
...
public class ReservationController {
    ...
    @GetMapping("/report-dates/{dateInit}/{dateEnd}")
    public List<Reservation> getReservationReportByDates(@PathVariable("dateInit") String date1, @PathVariable("dateEnd") String date2 ){
